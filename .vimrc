...
let @w = "magg/sholllyt.'a"
let @q = '0:s/UIAlertView/UIAlertController/f=hd0iUIAlertController *alertf[xWdExvecalertControllerWithTitlejjXCCSpreferredStyle:UIAlertControllerStyleAlertodebugTag:<#tag#>]; 0wdt:iUIAlert ���kbAction *cancelAction = [UIAlertAction actionWithTitleostyle:UIAlertActionStyleCancel"zPjjo[aerlt�kb�kb�kb�kblert addAction:cancelAction];jg^df:f;:call AdamMacro()@w'
